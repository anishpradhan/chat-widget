...
function requireReactDomClient_production() {
  ...
  var Scheduler = requireScheduler(), React2 = React__default, ReactDOM$1 = ReactDOM;
  ...
  var isArrayImpl = Array.isArray, ReactSharedInternals = React2.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, ReactDOMSharedInternals = ReactDOM$1.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, sharedNotPendingObject = {
    pending: false,
    data: null,
    method: null,
    action: null
...
var r$2 = (t2, e, n2) => (d(t2, typeof e != "symbol" ? e + "" : e, n2), n2);
let o$3 = class o {
  constructor() {
...
let n$1 = (e, t2) => {
  s$3.isServer ? useEffect(e, t2) : useLayoutEffect(e, t2);
};
function s$2(e) {
  let r2 = useRef(e);
  return n$1(() => {
...
var O = ((a) => (a[a.None = 0] = "None", a[a.RenderStrategy = 1] = "RenderStrategy", a[a.Static = 2] = "Static", a))(O || {}), A$1 = ((e) => (e[e.Unmount = 0] = "Unmount", e[e.Hidden = 1] = "Hidden", e))(A$1 || {});
function L$2() {
  let n2 = U$1();
  return useCallback((r2) => C$1(__spreadValues({ mergeRefs: n2 }, r2)), [n2]);
}
function C$1({ ourProps: n2, theirProps: r2, slot: e, defaultTag: a, features: s2, visible: t2 = true, name: l2, mergeRefs: i2 }) {
  ...
  if (y2 & 1) {
    let _b = o3, { unmount: f2 = true } = _b, u2 = __objRest(_b, ["unmount"]);
    return u$2(f2 ? 0 : 1, { [0]() {
      return null;
    }, [1]() {
      return F(__spreadProps(__spreadValues({}, u2), { hidden: true, style: { display: "none" } }), e, a, l2, i2);
    } });
  }
...
function F(n2, r2 = {}, e, a, s2) {
  ...
  if (t2 === Fragment && (Object.keys(m(o3)).length > 0 || Object.keys(m(u2)).length > 0)) if (!isValidElement(f2) || Array.isArray(f2) && f2.length > 1) {
...
`));
    ...
    let d2 = f2.props, p2 = d2 == null ? void 0 : d2.className, c2 = typeof p2 == "function" ? (...R2) => t$2(p2(...R2), o3.className) : t$2(p2, o3.className), T2 = c2 ? { className: c2 } : {}, g2 = P$1(f2.props, m(h(o3, ["ref"])));
    for (let R2 in u2) R2 in g2 && delete u2[R2];
    return cloneElement(f2, Object.assign({}, g2, u2, y2, { ref: s2(H(f2), y2.ref) }, T2));
  }
  return createElement$1(t2, Object.assign({}, h(o3, ["ref"]), t2 !== Fragment && y2, t2 !== Fragment && u2), f2);
}
function U$1() {
  let n2 = useRef([]), r2 = useCallback((e) => {
...
function c$2(u2 = 0) {
  let [t2, l2] = useState(u2), g2 = useCallback((e) => l2(e), [t2]), s2 = useCallback((e) => l2((a) => a | e), [t2]), m2 = useCallback((e) => (t2 & e) === e, [t2]), n2 = useCallback((e) => l2((a) => a & ~e), [l2]), F2 = useCallback((e) => l2((a) => a ^ e), [l2]);
...
function x$1(t2, n2, e, i2) {
  let [r2, o3] = useState(e), { hasFlag: s2, addFlag: a, removeFlag: l2 } = c$2(t2 && r2 ? 3 : 0), u2 = useRef(false), f2 = useRef(false), E = p$1();
  return n$1(() => {
    var d2;
    if (t2) {
      if (e && o3(true), !n2) {
...
function l() {
  let r2 = s$1(), [e, n2] = React.useState(s$3.isHandoffComplete);
  return e && s$3.isHandoffComplete === false && n2(false), React.useEffect(() => {
    e !== true && n2(true);
  }, [e]), React.useEffect(() => s$3.handoff(), []), r2 ? false : e;
}
function f() {
  let e = useRef(false);
...
function ue(e) {
  var t2;
  return !!(e.enter || e.enterFrom || e.enterTo || e.leave || e.leaveFrom || e.leaveTo) || ((t2 = e.as) != null ? t2 : de) !== Fragment || React__default.Children.count(e.children) === 1;
}
...
function Te(e, t2) {
  let n2 = s$2(e), l2 = useRef([]), S2 = f(), R2 = p$1(), d2 = o$1((o3, i2 = A$1.Hidden) => {
    let a = l2.current.findIndex(({ el: s2 }) => s2 === o3);
    a !== -1 && (u$2(i2, { [A$1.Unmount]() {
  ...
  }), C2 = useRef([]), p2 = useRef(Promise.resolve()), h2 = useRef({ enter: [], leave: [] }), g2 = o$1((o3, i2, a) => {
    ...
    })]), i2 === "enter" ? p2.current = p2.current.then(() => t2 == null ? void 0 : t2.wait.current).then(() => a(i2)) : a(i2);
  }), v = o$1((o3, i2, a) => {
  ...
  return useMemo(() => ({ children: l2, register: y2, unregister: d2, onStart: g2, onStop: v, wait: p2, chains: h2 }), [y2, d2, l2, g2, v, h2, p2]);
}
...
function Ae(e, t2) {
  ...
  n$1(() => A2(r2), [A2, r2]), n$1(() => {
    if (H2 === A$1.Hidden && r2.current) {
      ...
      return u$2(m$12, { ["hidden"]: () => I(r2), ["visible"]: () => A2(r2) });
    }
  }, [m$12, r2, A2, I, u2, H2]);
  let B = l();
  n$1(() => {
    if (f2 && B && m$12 === "visible" && r2.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [r2, m$12, B, f2]);
  let ce = K2 && !z, Y = z && u2 && K2, W = useRef(false), L2 = Te(() => {
    W.current || (G2("hidden"), I(r2));
  }, Q), Z = o$1((k) => {
    W.current = true;
    ...
    }), F2 === "leave" && !U(L2) && (G2("hidden"), I(r2));
  });
  useEffect(() => {
    f2 && n2 || (Z(u2), $2(u2));
  }, [u2, f2, n2]);
  let pe = /* @__PURE__ */ (() => !(!n2 || !f2 || !B || ce))(), [, T2] = x$1(pe, a, u2, { start: Z, end: $2 }), Ce = m(__spreadValues({ ref: j2, className: ((te = t$2(i$12.className, Y && y$1, Y && C2, T2.enter && y$1, T2.enter && T2.closed && C2, T2.enter && !T2.closed && p2, T2.leave && g2, T2.leave && !T2.closed && v, T2.leave && T2.closed && o3, !T2.transition && u2 && h2)) == null ? void 0 : te.trim()) || void 0 }, R(T2))), N = 0;
  m$12 === "visible" && (N |= i.Open), m$12 === "hidden" && (N |= i.Closed), u2 && m$12 === "hidden" && (N |= i.Opening), !u2 && m$12 === "visible" && (N |= i.Closing);
  let he = L$2();
...
function Ie(e, t2) {
  ...
  let [h2, g2] = useState(n2 ? "visible" : "hidden"), v = Te(() => {
    n2 || g2("hidden");
  }), [o3, i$12] = useState(true), a = useRef([n2]);
  n$1(() => {
    o3 !== false && a.current[a.current.length - 1] !== n2 && (a.current.push(n2), i$12(false));
  }, [a, n2]);
  let s2 = useMemo(() => ({ show: n2, appear: l$1, initial: o3 }), [n2, l$1, o3]);
  n$1(() => {
    n2 ? g2("visible") : !U(v) && d2.current !== null && g2("hidden");
  }, [n2, v]);
  let r2 = { unmount: S2 }, f2 = o$1(() => {
    var u2;
    o3 && i$12(false), (u2 = e.beforeEnter) == null || u2.call(e);
  }), j2 = o$1(() => {
    var u2;
    o3 && i$12(false), (u2 = e.beforeLeave) == null || u2.call(e);
  }), H2 = L$2();
  return React__default.createElement(M.Provider, { value: v }, React__default.createElement(w$1.Provider, { value: s2 }, H2({ ourProps: __spreadProps(__spreadValues({}, r2), { as: Fragment, children: React__default.createElement(me, __spreadProps(__spreadValues(__spreadValues({ ref: C2 }, r2), R2), { beforeEnter: f2, beforeLeave: j2 })) }), theirProps: {}, defaultTag: Fragment, features: fe, visible: h2 === "visible", name: "Transition" })));
}
function Le(e, t2) {
  let n2 = useContext(w$1) !== null, l2 = u() !== null;
  return React__default.createElement(React__default.Fragment, null, !n2 && l2 ? React__default.createElement(X, __spreadValues({ ref: t2 }, e)) : React__default.createElement(me, __spreadValues({ ref: t2 }, e)));
}
...
function ownKeys$2(e, r2) {
  ...
  if (Object.getOwnPropertySymbols) {
    var o22 = Object.getOwnPropertySymbols(e);
...
var s = "classic", t = "duotone", r = "sharp", o2 = "sharp-duotone", L = [s, t, r, o2];
var G = {
  classic: {
    900: "fas",
    400: "far",
...
function IoMdSend(props) {
  return GenIcon({ "attr": { "viewBox": "0 0 512 512" }, "child": [{ "tag": "path", "attr": { "d": "M48 448l416-192L48 64v149.333L346 256 48 298.667z" }, "child": [] }] })(props);
}
...
const fetchAdapter = isFetchSupported && ((config2) => __async(null, null, function* () {
  let {
    url,
    method,
    data,
...
const REACT_APP_API_URL = "http://localhost:8000/chat";
const REACT_APP_SOCKET_URL = "ws://localhost:8000/ws/livechat/chatrooms";
const REACT_APP_TENANT_URL = "http://localhost:8000/tenants";
const ChatWidget = ({ expanded, setExpanded }) => {
  ...
  useEffect(() => {
    if (expanded && isFormSubmitted) {
      setTimeout(() => {
        scrollToBottom();
      }, 10);
    }
  }, [expanded, isFormSubmitted]);
  const SenderMessage = ({ message }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row-reverse items-top space-x-2 space-x-reverse space-y-6 ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative px-4 py-4 bg-blue-600 rounded-2xl text-white text-left max-w-[85%]", children: message }) });
  const ReceivedMessage = ({ message }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-top space-x-2 space-y-6 ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative px-4 py-4 bg-gray-200 rounded-2xl text-black text-left max-w-[85%]", children: message }) });
  ...
  const connectWebSocket = (roomId) => {
    const wsUrl = `${REACT_APP_SOCKET_URL}/${roomId}/`;
    ...
    newSocket.onmessage = (event) => {
      ...
      if (data.command === "new_message") {
        ...
        const isFromUser = messageData.name === formData.name;
        if (!isFromUser) {
          setMessages((prev) => [...prev, {
            type: "received",
            message: messageData.message,
            timestamp: messageData.sent
          }]);
        }
      }
    };
  ...
  const handleFormSubmit = (e) => __async(null, null, function* () {
    e.preventDefault();
    setIsLoading(true);
    try {
      ...
      const getTenantUuid = yield axios.get(`${REACT_APP_TENANT_URL}/api/get_tenant_uuid`, {
        params: {
          schema_name: "ResearchBase"
        }
      });
      const tenant_uuid = getTenantUuid.data.tenant_uuid;
      const response = yield axios.post(
        `${REACT_APP_API_URL}/api/create_room/`,
        formDataToSend,
        {
          headers: {
            "Content-Type": "multipart/form-data",
      ...
      if (response.data.chat_id) {
        ...
        connectWebSocket(response.data.chat_id);
        setMessages([
          { type: "received", message: "Hello! How may I help you?" },
          { type: "sent", message: formData.question }
        ]);
      }
    } catch (error) {
  ...
  const handleSendMessage = () => __async(null, null, function* () {
    ...
    setMessages((prev) => [...prev, { type: "sent", message: newMessage }]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ze,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed right-6 bottom-4 origin-bottom-right sm:right-6 sm:bottom-4 sm:origin-bottom-right inset-0 sm:inset-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          id: "window",
          className: "w-full h-full sm:w-[370px] sm:max-h-[700px] sm:h-auto relative -bottom-4 -right-4 sm:relative sm:bottom-4 sm:right-0 flex flex-col bg-white rounded-2xl sm:rounded-2xl rounded-none shadow-lg text",
          ref: chatContainerRef,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 bg-gradient-to-r from-blue-700  to-sky-400 h-32 sm:h-40 rounded-t-2xl sm:rounded-t-2xl rounded-none flex items-center justify-between shadow-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center relative space-x-3  text-neutral-100 ", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-full" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 text-base sm:text-lg font-semibold", children: "Chat with us!" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex justify-center items-center space-x-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-gradient-to-r from-blue-700 to-sky-400 text-white px-4 sm:px-6 pt-3 sm:pt-4 pb-4 sm:pb-6 border-t-[1px] border-t-white", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "svg",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "path",
                    {
                      d: "M-1 50C463 149 739-50 1441 56L1443 113-1 111Z",
                      fill: "white"
                    }
                  )
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-left text-sm sm:text-base font-medium", children: "We typically reply in few minutes." })
            ] }),
            !isFormSubmitted ? (
              // Form Section
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col p-4 sm:p-6 space-y-4 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-800", children: "Start a conversation" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleFormSubmit, className: "space-y-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "How can we help you? *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "textarea",
                      {
                        name: "question",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  {
                    ref: chatContainerRef,
                    className: "flex flex-col overflow-y-auto py-4 px-4 sm:px-6 space-y-3 text-sm flex-1 max-h-[calc(100vh-200px)] sm:max-h-[400px]",
                    children: [
                      messages.map((msg, index) => msg.type === "sent" ? /* @__PURE__ */ jsxRuntimeExports.jsx(SenderMessage, { message: msg.message }, index) : /* @__PURE__ */ jsxRuntimeExports.jsx(ReceivedMessage, { message: msg.message }, index)),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: messagesEndRef })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center px-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center w-full border-t-[1px]", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "text",
                        ...
                        className: "relative w-full h-12 rounded-lg px-2 outline-none border-none focus:border-none focus:outline-hidden focus:ring-0 disabled:opacity-50"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      IoMdSend,
                      {
                        title: "Send",
                        className: `w-6 h-6 cursor-pointer ${newMessage.length && isConnected ? "text-blue-700" : "text-gray-200"}`,
                        onClick: handleSendMessage
                      }
                    )
                  ] }),
                  !isConnected && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500 mt-1", children: "Connecting to chat..." })
                ] })
              ] })
            )
          ]
...
const Content = ({ expanded, setExpanded }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ze,
    {
      show: !expanded,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed right-4 bottom-2 md:right-4 md:bottom-2 origin-bottom z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "relative right-6 bottom-4 md:right-6 md:bottom-4 p-3 md:p-3 text-center bg-blue-500 shadow-lg rounded-full hover:cursor-pointer hover:bg-blue-600",
          onClick: () => {
            setExpanded(!expanded);
          },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const LiveChatWidget = ({
  ...
  if (socketUrl) {
    window.VITE_SOCKET_URL = socketUrl;
  }
  if (tenantUrl) {
    window.VITE_TENANT_URL = tenantUrl;
  }
  console.log("Widget config:", { position, theme, title, subtitle });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `live-chat-widget live-chat-widget--${position} live-chat-widget--${theme}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ChatWidget, { expanded, setExpanded }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Content, { expanded, setExpanded })
  ] });
};
const initLiveChatWidget = (config2 = {}) => {
  const container = document.createElement("div");
  container.id = "live-chat-widget-container";
  document.body.appendChild(container);
  const root = clientExports.createRoot(container);
  root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(LiveChatWidget, __spreadValues({}, config2)));
};
document.addEventListener("DOMContentLoaded", () => {
  const script = document.currentScript || document.querySelector("script[data-widget]");
  if (script) {
    const config2 = {
      apiUrl: script.getAttribute("data-api-url"),
      socketUrl: script.getAttribute("data-socket-url"),
      tenantUrl: script.getAttribute("data-tenant-url")
    };
    initLiveChatWidget(config2);
  }
});
...
//# sourceMappingURL=live-chat-widget.js.map
